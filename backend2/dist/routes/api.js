...
router.get("/ascii", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
...
// post move
router.post("/move", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        chess.move(req.body);
...
// get board fen
router.get("/fen", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        res.send({ fen: chess.fen(), turn: chess.turn() });
        return [2 /*return*/];
    });
